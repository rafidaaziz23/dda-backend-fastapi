...
t = TelemetryData(
    ...
    avg_enemies_alive_simultaneously=9.0
)
label, probs, params, ms, notes = engine.evaluate("FCM", t)
...
t2 = TelemetryData(
    ...
    avg_enemies_alive_simultaneously=1.5
)
label2, probs2, params2, ms2, notes2 = engine.evaluate("GMM", t2)
